...
library (107 stars, 64 patterns, 12 palaces, 4 transformations, 38 glossary entries, taken from the
学习 pages of iztro-docs, MIT License, by Sylar Long). Disagree with it and you write an overlay
