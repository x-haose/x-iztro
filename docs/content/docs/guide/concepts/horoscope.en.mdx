...
The childhood scope takes a palace per nominal age, by the mnemonic "first Soul, second Wealth,
third Health, fourth Spouse, fifth Spirit, sixth Career":

| Nominal age | 1 | 2 | 3 | 4 | 5 |
| --- | --- | --- | --- | --- | --- |
| Childhood palace | soul | wealth | health | spouse | spirit |

The table stops at nominal age 5: the latest start is fire 6th, whose first decadal begins at 6, so
age 6 onwards is never the childhood scope — the mnemonic's "sixth Career" never applies, and there
is no cycling.
...
```text
decadal gengchen ['sun', 'warrior', 'moon', 'fortunate']
age nominal age 25
yearly jiachen
