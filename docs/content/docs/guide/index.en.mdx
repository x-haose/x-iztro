...
the two must agree field for field — a line held by roughly 710,000 golden test cases. See
...
<Cards>
  ...
  <Card
    ...
    description="How roughly 710,000 golden cases keep the output identical to iztro"
  />
</Cards>
