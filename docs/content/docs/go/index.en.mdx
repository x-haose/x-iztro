...
| The `With` form of each (`ToTextWith(opts TextOptions)` etc.) | `ToTextWithContext` / `PalaceToTextWithContext` / `SurroundedPalacesToTextWithContext` / `PatternsToTextWithContext` |
