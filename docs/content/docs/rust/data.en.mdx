...
```text
Earth
["sun", "warrior", "empress", "fortunate"]
["judge", "rebel", "warrior", "sun"]
Some(Miao)
earth 5th
```
...
```text
162 20
emperor advisor sun warrior fortunate judge empress moon wolf advocator minister sage marshal rebel scholar artist impulsive spark driven tangled
```
