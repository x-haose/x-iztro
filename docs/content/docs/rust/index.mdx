...
| `x_iztro::text` | `astrolabe_to_text`、`horoscope_to_text`、`palace_to_text`、`surrounded_palaces_to_text`、`patterns_to_text` | [排盘入口](/zh/docs/rust/astro#astrolabe_to_text--horoscope_to_text) |
