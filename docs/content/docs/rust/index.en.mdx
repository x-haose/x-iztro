...
| `x_iztro::text` | `astrolabe_to_text`, `horoscope_to_text`, `palace_to_text`, `surrounded_palaces_to_text`, `patterns_to_text` with their `_with` forms, and `TextOptions` | [Charting entries](/en/docs/rust/astro#astrolabe_to_text--horoscope_to_text), [TextOptions](/en/docs/rust/astro#textoptions) |
